...
## Visualise detection
```{r plot-Detection, cache=TRUE, message=FALSE}
require(sparta)
...
for(i in 1:length(files2)){
  ...
  list2[[i]] <- plot_DetectionOverTime(out, out$SPP_NAME)
}
...
# Load generalists vs. specialist looku-up table
