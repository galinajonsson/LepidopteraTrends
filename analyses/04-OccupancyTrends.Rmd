...
Pyronia.tithonus does not converge at 80k iterations and will not be considered here
...
### BMA
```{r BMA, cache=TRUE, message=FALSE}
...
```{r MSI, cache=TRUE, message=FALSE}
...
```{r percentdif, cache=TRUE, message=FALSE}
