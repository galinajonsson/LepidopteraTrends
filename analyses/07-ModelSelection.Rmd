...
#### *Aglais urticae*
```{r plot-detprob-outputs1, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE, eval=FALSE}
plot_DetectionOverTime(catLL_list[[1]],
  ...
  ggtitle(label = "*Aglais urticae* - Model A", 
          subtitle = paste(lama_translate_("Aglais urticae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
#### *Carterocephalus palaemon*
```{r plot-detprob-outputs2, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE, eval=FALSE}
plot_DetectionOverTime(catLL_list[[2]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Carterocephalus palaemon - Model A", 
          subtitle = paste(lama_translate_("Carterocephalus palaemon", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
#### *Erebia aethiops*
```{r plot-detprob-outputs3, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE, eval=FALSE}
plot_DetectionOverTime(catLL_list[[3]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Erebia aethiops - Model A", 
          subtitle = paste(lama_translate_("Erebia aethiops", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
#### *Erebia epiphron*
```{r plot-detprob-outputs4, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE, eval=FALSE}
plot_DetectionOverTime(catLL_list[[4]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Erebia epiphron - Model A", 
          subtitle = paste(lama_translate_("Erebia epiphron", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
