...
Binned residuals are plotted according to the methodology of from [Gelman *et al*., (2000)](https://doi.org/10.1111/1467-9876.00190) 
  
```{r exampleWrightPlot, echo=TRUE, eval=TRUE}
# Read files
...
occuWright_yr1to6 <- subset(occuWright, Year <= 6) # 544500
