...
############################ *Carterocephalus palaemon*
test2 <- subset(sppMeanSitesYear, Species == "*Carterocephalus palaemon*")

test2$Model <- as.factor(test2$Model)
...
ggplot(data = test2,) +
  ...
  scale_fill_manual(values =c("#440154FF",
                                    "#20A387FF",
                                    "#E69F00")) + 
  geom_line(aes(x = Year, y = sim_MeanSitesPerYear, colour = Model), size=0.7, alpha=0.9) + 
          scale_colour_manual(values =c("#440154FF",
                                    "#20A387FF",
                                    "#E69F00")) +
  geom_line(aes(x=Year, y=obs_meanSitesPerYear), linetype = "dotted", colour=c("black"), size = 1.5) +
...
```{r BayesianP, message=FALSE, warning=FALSE, cache=TRUE}
