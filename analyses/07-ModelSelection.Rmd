...
### Occupancy estimates {.tabset .tabset-dropdown}
```{r plot-occu-outputs-setup, message=FALSE, warning=FALSE, echo=FALSE}
require(ggplot2)
...
#### *Aglais urticae*
```{r plot-occu-outputs1, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
### Source plotting function
source("./fig-plot.Occdet_G.R")
...
```{r plot-occu-outputs2, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Erebia aethiops*
```{r plot-occu-outputs3, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Erebia epiphron*
```{r plot-occu-outputs4, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Limenitis camilla*
```{r plot-occu-outputs5, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Lycaena phlaeas*
```{r plot-occu-outputs6, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Melitaea athalia*
```{r plot-occu-outputs7, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Pararge aegeria*
```{r plot-occu-outputs8, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Pieris rapae*
```{r plot-occu-outputs9, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
### Source plotting function
source("./fig-plot.Occdet_G.R")
...
#### *Polygonia c-album*
```{r plot-occu-outputs10, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
```{r plot-occu-outputs11, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Thecla betulae*
```{r plot-occu-outputs12, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
### Detection probability estimates {.tabset .tabset-dropdown}
```{r plot-detprob-outputs-setup, message=FALSE, warning=FALSE, echo=FALSE}
require(ggplot2)
require(labelmachine)
require(sparta)
require(dplyr)
...
#### *Aglais urticae*
```{r plot-detprob-outputs1, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
#### *Carterocephalus palaemon*
```{r plot-detprob-outputs2, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[2]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
    ggtitle(label = (expression(paste(italic("Carterocephalus palaemon"), " - Model A"))), 
          subtitle = paste(lama_translate_("Carterocephalus palaemon", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[2]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
    ggtitle(label = (expression(paste(italic("Carterocephalus palaemon"), " - Model B"))), 
          subtitle = paste(lama_translate_("Carterocephalus palaemon", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[2]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
    ggtitle(label = (expression(paste(italic("Carterocephalus palaemon"), " - Model C"))), 
          subtitle = paste(lama_translate_("Carterocephalus palaemon", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Erebia aethiops*
```{r plot-detprob-outputs3, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[3]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
      ggtitle(label = (expression(paste(italic("Erebia aethiops"), " - Model A"))), 
          subtitle = paste(lama_translate_("Erebia aethiops", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[3]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
      ggtitle(label = (expression(paste(italic("Erebia aethiops"), " - Model B"))), 
          subtitle = paste(lama_translate_("Erebia aethiops", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[3]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
      ggtitle(label = (expression(paste(italic("Erebia aethiops"), " - Model C"))), 
          subtitle = paste(lama_translate_("Erebia aethiops", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Erebia epiphron*
```{r plot-detprob-outputs4, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[4]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Erebia epiphron"), " - Model A"))), 
          subtitle = paste(lama_translate_("Erebia epiphron", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[4]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Erebia epiphron"), " - Model B"))), 
          subtitle = paste(lama_translate_("Erebia epiphron", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[4]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Erebia epiphron"), " - Model C"))), 
          subtitle = paste(lama_translate_("Erebia epiphron", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Limenitis camilla*
```{r plot-detprob-outputs5, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[5]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Limenitis camilla"), " - Model A"))), 
          subtitle = paste(lama_translate_("Limenitis camilla", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[5]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Limenitis camilla"), " - Model B"))), 
          subtitle = paste(lama_translate_("Limenitis camilla", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[5]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Limenitis camilla"), " - Model C"))), 
          subtitle = paste(lama_translate_("Limenitis camilla", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Lycaena phlaeas*
```{r plot-detprob-outputs6, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[6]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Lycaena phlaeas"), " - Model A"))), 
          subtitle = paste(lama_translate_("Lycaena phlaeas", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[6]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Lycaena phlaeas"), " - Model B"))),  
          subtitle = paste(lama_translate_("Lycaena phlaeas", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[6]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Lycaena phlaeas"), " - Model C"))),  
          subtitle = paste(lama_translate_("Lycaena phlaeas", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Melitaea athalia*
```{r plot-detprob-outputs7, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[7]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Melitaea athalia"), " - Model A"))), 
          subtitle = paste(lama_translate_("Melitaea athalia", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[7]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Melitaea athalia"), " - Model B"))), 
          subtitle = paste(lama_translate_("Melitaea athalia", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[7]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Melitaea athalia"), " - Model C"))),  
          subtitle = paste(lama_translate_("Melitaea athalia", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Pararge aegeria*
```{r plot-detprob-outputs8, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[8]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Pararge aegeria"), " - Model A"))), 
          subtitle = paste(lama_translate_("Pararge aegeria", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[8]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Pararge aegeria"), " - Model B"))), 
          subtitle = paste(lama_translate_("Pararge aegeria", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[8]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Pararge aegeria"), " - Model C"))), 
          subtitle = paste(lama_translate_("Pararge aegeria", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Pieris rapae*
```{r plot-detprob-outputs9, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[9]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Pieris rapae"), " - Model A"))), 
          subtitle = paste(lama_translate_("Pieris rapae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[9]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Pieris rapae"), " - Model B"))),  
          subtitle = paste(lama_translate_("Pieris rapae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[9]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Pieris rapae"), " - Model C"))), 
          subtitle = paste(lama_translate_("Pieris rapae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Polygonia c-album*
```{r plot-detprob-outputs10, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[10]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Polygonia c-album"), " - Model A"))), 
          subtitle = paste(lama_translate_("Polygonia c-album", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[10]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Polygonia c-album"), " - Model B"))), 
          subtitle = paste(lama_translate_("Polygonia c-album", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[10]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Polygonia c-album"), " - Model C"))), 
          subtitle = paste(lama_translate_("Polygonia c-album", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Polyommatus bellargus*
```{r plot-detprob-outputs11, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[11]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Polyommatus bellargus"), " - Model A"))), 
          subtitle = paste(lama_translate_("Polyommatus bellargus", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[11]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Polyommatus bellargus"), " - Model B"))),
          subtitle = paste(lama_translate_("Polyommatus bellargus", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[11]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Polyommatus bellargus"), " - Model C"))),
          subtitle = paste(lama_translate_("Polyommatus bellargus", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Thecla betulae*
```{r plot-detprob-outputs12, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
plot_DetectionOverTime(catLL_list[[12]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
        ggtitle(label = (expression(paste(italic("Thecla betulae"), " - Model A"))), 
          subtitle = paste(lama_translate_("Thecla betulae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
...
plot_DetectionOverTime(mixLL_list[[12]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Thecla betulae"), " - Model B"))), 
          subtitle = paste(lama_translate_("Thecla betulae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
...
plot_DetectionOverTime(mixLL2_list[[12]],
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = (expression(paste(italic("Thecla betulae"), " - Model C"))), 
          subtitle = paste(lama_translate_("Thecla betulae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
*Aglais urticae* (Small Tortoiseshell) is one of our most widespread butterflies, occurring throughout the British Isles, which is in line with the latter part of the time series (post 1976; but note it has declined by approx 15% since). Nonetheless, there is no anecdotal evidence for a 100% increase between the 1960s and 1980s indicating that the occupanncy is underestimated in the early part of the time series. 
...
BNM and UKBMS detection probability trends are very similar for all three models after 19976. However, NHCs detection probability estimates differ between models such that it is the data type with the highest detection probability (unlikely) in Model A, and the lowest in model B and C; still the detection probability estimates are around 0.05-0.1 for model B (meaning that every 5-10% of museum visits collected a small tortoisshell, which again seems unlikely as that in turn would mean the same percentage of the entire collection would be small tortoisshells).

Please note I have **sense checked** these trends (i.e. compared with actual mean annual estimates and they are correct).  
