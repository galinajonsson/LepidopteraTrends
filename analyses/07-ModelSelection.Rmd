...
* If statement: detProb plotting function  
* Tidy plot Bayesian *p*-values
* Fix Rhat function I broke  
* Annotate shiny plotting code
* Rewrite shiny code detprob as rmarkdown
* Get outputs for all catLL outputs
    + *Polyommatus bellargus*   
    + *Thecla betulae*   
    + *Polygonia c-album*   
    + *Pieris rapae*  
* Run Py summary for all catLL outputs
    + *Polyommatus bellargus*   
    + *Thecla betulae*   
    + *Polygonia c-album*   
    + *Pieris rapae*   
...
#######################  Model A  ########################
##########################################################
ModelNames20210619 <- c('Aglais_urticae',
               'Carterocephalus_palaemon',
               'Erebia_aethiops',
               'Erebia_epiphron',
               'Limenitis_camilla',
...
ModelNames_catLL <- paste(ModelNames20210619, "catLL", sep="_") # Add '_catLL' to model names
...
#RhatSummary <- summarise_Rhat(mixLL_list, 
#                              verbose=FALSE)
...
#### *Pieris rapae*
```{r plot-occu-outputs9, message=FALSE, warning=FALSE, echo=FALSE}
...
#### *Polygonia c-album*
```{r plot-occu-outputs10, message=FALSE, warning=FALSE, echo=FALSE}
...
#### *Polyommatus bellargus*
```{r plot-occu-outputs11, message=FALSE, warning=FALSE, echo=FALSE}
...
#### *Thecla betulae*
```{r plot-occu-outputs12, message=FALSE, warning=FALSE, echo=FALSE}
...
plot_DetectionOverTime(mixLL_list[[1]], 
  ...
  ggtitle(label = "Aglais urticae - Model B", 
          subtitle = paste(lama_translate_("Aglais urticae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[1]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Aglais urticae - Model C", 
          subtitle = paste(lama_translate_("Aglais urticae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))
```
...
plot_DetectionOverTime(mixLL_list[[2]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Carterocephalus palaemon - Model B", 
          subtitle = paste(lama_translate_("Carterocephalus palaemon", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[2]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Carterocephalus palaemon - Model C", 
          subtitle = paste(lama_translate_("Carterocephalus palaemon", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
plot_DetectionOverTime(mixLL_list[[3]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Erebia aethiops - Model B", 
          subtitle = paste(lama_translate_("Erebia aethiops", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[3]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Erebia aethiops - Model C", 
          subtitle = paste(lama_translate_("Erebia aethiops", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
plot_DetectionOverTime(mixLL_list[[4]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Erebia epiphron - Model B", 
          subtitle = paste(lama_translate_("Erebia epiphron", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[4]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Erebia epiphron - Model C", 
          subtitle = paste(lama_translate_("Erebia epiphron", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
plot_DetectionOverTime(mixLL_list[[5]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Limenitis camilla - Model B", 
          subtitle = paste(lama_translate_("Limenitis camilla", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[5]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Limenitis camilla - Model C", 
          subtitle = paste(lama_translate_("Limenitis camilla", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
plot_DetectionOverTime(mixLL_list[[6]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Lycaena phlaeas - Model B", 
          subtitle = paste(lama_translate_("Lycaena phlaeas", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[6]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Lycaena phlaeas - Model C", 
          subtitle = paste(lama_translate_("Lycaena phlaeas", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
plot_DetectionOverTime(mixLL_list[[7]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Melitaea athalia - Model B", 
          subtitle = paste(lama_translate_("Melitaea athalia", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[7]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Melitaea athalia - Model C", 
          subtitle = paste(lama_translate_("Melitaea athalia", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
plot_DetectionOverTime(mixLL_list[[8]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Pararge aegeria - Model B", 
          subtitle = paste(lama_translate_("Pararge aegeria", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[8]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Pararge aegeria - Model C", 
          subtitle = paste(lama_translate_("Pararge aegeria", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Pieris rapae*
```{r plot-detprob-outputs9, message=FALSE, warning=FALSE, echo=FALSE}
### Source plotting function
source("./plot-Det_mixLL2.R")
...
plot_DetectionOverTime(mixLL_list[[9]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Pieris rapae - Model B", 
          subtitle = paste(lama_translate_("Pieris rapae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[9]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Pieris rapae - Model C", 
          subtitle = paste(lama_translate_("Pieris rapae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Polygonia c-album*
```{r plot-detprob-outputs10, message=FALSE, warning=FALSE, echo=FALSE}
### Source plotting function
source("./plot-Det_mixLL2.R")
...
plot_DetectionOverTime(mixLL_list[[10]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Polygonia c-album - Model B", 
          subtitle = paste(lama_translate_("Polygonia c-album", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[10]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Polygonia c-album - Model C", 
          subtitle = paste(lama_translate_("Polygonia c-album", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Polyommatus bellargus*
```{r plot-detprob-outputs11, message=FALSE, warning=FALSE, echo=FALSE}
### Source plotting function
source("./plot-Det_mixLL2.R")
...
plot_DetectionOverTime(mixLL_list[[11]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Polyommatus bellargus - Model B", 
          subtitle = paste(lama_translate_("Polyommatus bellargus", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[11]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Polyommatus bellargus - Model C", 
          subtitle = paste(lama_translate_("Polyommatus bellargus", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
#### *Thecla betulae*
```{r plot-detprob-outputs12, message=FALSE, warning=FALSE, echo=FALSE}
### Source plotting function
source("./plot-Det_mixLL2.R")
...
plot_DetectionOverTime(mixLL_list[[12]], 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Thecla betulae - Model B", 
          subtitle = paste(lama_translate_("Thecla betulae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15))

plot_DetectionOverTime_mixLL2(mixLL2_list[[12]],
                              min.yr = 1900, 
                                  legend_labels = c("BNM_LL1/Year_Effect", 
                                                    "UKBMS", 
                                                    "NHCs", 
             ...
             scale_y_continuous(limits=c(0, 1), expand = c(0, 0)) +
             scale_x_continuous(expand = c(0, 0)) +
  ggtitle(label = "Thecla betulae - Model C", 
          subtitle = paste(lama_translate_("Thecla betulae", dict, "common_names"))) + 
  theme(plot.title=element_text(face="italic")) +
  theme(text=element_text(size=15)) 
```
...
Melitaea_athalia_catLL <- catLL_list[[7]]
...
# recompile the model
Melitaea_athalia_catLL$model$recompile()

#out$model$recompile()

# Sample 100 iterations of each of the 3 chains and thin by 3, giving 99 samples
samp <- rjags:::coda.samples(model=Melitaea_athalia_catLL$model, 
...
temp_data <- Melitaea_athalia_catLL$model$data()
...
# save this file
write.csv(RR1, "../outputs/posteriorPredictiveChecks-outputs/Melitaea_athalia_catLL_RR1.csv")
...
# save this file
write.csv(RR2, "../outputs/posteriorPredictiveChecks-outputs/Melitaea_athalia_catLL_RR2.csv")
```
...
```{r read-PostPredCheck-Data, message=FALSE, warning=FALSE, cache=TRUE, eval=FALSE}
require("reshape2")
require("dplyr")
require("tidyr")
require("ggplot2")
...
```{r varianceAndModel, message=FALSE, warning=FALSE, cache=TRUE, eval=FALSE}
require("rjags")
require("coda")
require("reshape2")
require("dplyr")
...
```{r BayesianP, message=FALSE, warning=FALSE, cache=TRUE, eval=FALSE}
...
```{r plot-PySummary, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, eval=FALSE}
...
```{r plotBp, echo=FALSE, warning=FALSE, cache=TRUE, eval=FALSE}
bpDF <- data.frame(Species= c('Aglais_urticae',
               'Carterocephalus_palaemon',
               'Erebia_aethiops',
               'Erebia_epiphron',
               'Limenitis_camilla',
...
ggplot(bpDF, aes(x=mixLL, y=mixLL2)) +
  geom_point() + 
  ggtitle("Bayesian p - Mean (across years) proportion of sites with a record") + 
  theme_bw() +
  geom_abline(aes(intercept=0, slope=1))

ggplot(bpDF, aes(x=mixLL, y=mixLL2)) +
  geom_point() + 
  geom_text(label=bpDF$Species) +
  ggtitle("Bayesian p - Mean (across years) proportion of sites with a record with spp names") + theme_bw() +
  geom_abline(aes(intercept=0, slope=1))
```
...
* Given that the 'optimal' p-value is 0.5, is *Limenitis camilla* (0.48 for mixLL2/Model C and 0.57 for for mixLL/Model B) "more" interesting than let's say *Erebia epiphron* (which shows the largest difference in p-vale between the two models)?   
* 
