...
plot.occDet_G(Aglais_urticae_ModelA, Aglais_urticae_ModelB, Aglais_urticae_ModelC) +
  ggtitle(label = "*Aglais urticae* - Occupancy", 
...
plot.occDet_G(Carterocephalus_palaemon_ModelA,
  ...
  ggtitle(label = "*Carterocephalus palaemon* Occupancy", 
...
binnedplot(occuWright_yr1to6$muZ_value, 
           ...
           xlab="Occupancy", 
           ylab="Binned residuals",
           main = "Binned residual plot: 1900-1905 - C. palaemon* Model A")
...
binnedplot(occuWright_yr76to82$muZ_value, 
           ...
           xlab="Occupancy", 
           ylab="Binned residuals",
           main = "Binned residual plot: 1975-1981 - *C. palaemon* Model A")
...
binnedplot((occuWright_5iter$Year+1899), 
           ...
           xlab="Year", 
           ylab="Binned residuals",
           main = "Binned residual plot: 5 iterations - *C. palaemon* Model A")
...
#### Extract resuduals
```{r WrightResiduals-Cpalaemon-ModelB, echo=FALSE, eval=FALSE, cache=TRUE}
# Load required packages
require("rjags")
require("coda")
require("reshape2")
...
```{r WrightPlot-Cpalaemon-ModelB, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE}
# Read file
...
binnedplot(occuWright_yr1to6$muZ_value, 
           ...
           xlab="Occupancy", 
           ylab="Binned residuals",
           main = "Binned residual plot: 1900-1905 - C. palaemon* Model B")
...
binnedplot(occuWright_yr76to82$muZ_value, 
           ...
           xlab="Occupancy", 
           ylab="Binned residuals",
           main = "Binned residual plot: 1975-1981 - C. palaemon* Model B")

binnedplot((occuWright_5iter$Year+1899), 
           occuWright_5iter$res,
           xlab="Year", 
           ylab="Binned residuals",
           main = "Binned residual plot: 5 iterations - C. palaemon* Model B")
...
#### Extract resuduals
```{r WrightResiduals-Cpalaemon-ModelC, echo=FALSE, eval=FALSE, cache=TRUE}
# Load required packages
require("rjags")
require("coda")
require("reshape2")
...
```{r WrightPlot-Cpalaemon-ModelC, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE}
# Read file
...
binnedplot(occuWright_yr1to6$muZ_value, 
           ...
           xlab="Occupancy", 
           ylab="Binned residuals",
           main = "Binned residual plot: 1900-1905 - *C. palaemon* Model C")
...
binnedplot(occuWright_yr76to82$muZ_value, 
           ...
           xlab="Occupancy", 
           ylab="Binned residuals",
           main = "Binned residual plot: 1975-1981 - *C. palaemon* Model C")

binnedplot((occuWright_5iter$Year+1899), 
           occuWright_5iter$res,
           xlab="Year", 
           ylab="Binned residuals",
           main = "Binned residual plot: 5 iterations - *C. palaemon* Model C")
