...
```{r WrightOccuPlot-A-urticae, echo=FALSE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE, fig.width=7, fig.height=10}
# Load required packages
require(arm)
require(dplyr)
...
```{r WrightDetPlot-A-urticae-Part1, echo=FALSE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE, fig.width=7, fig.height=10}
# Load required packages
require(arm)
require(dplyr)
# Set up 3 rows 3 columns
...
### Plot all years: separate line colours for iterations of visits of different types
for(j in 1:10){
