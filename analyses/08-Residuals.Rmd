...
```{r WrightOccuPlot-C-palaemon, echo=FALSE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE, fig.width=7, fig.height=12}
# Load required packages
require(arm)
require(dplyr)
...
```{r WrightDetPlot-C-palaemon-Part1, echo=FALSE, eval=TRUE, warning=FALSE, message=FALSE, cache=TRUE, fig.width=7, fig.height=7}
# Load required packages
require(arm)
require(dplyr)
# Set up 3 rows 3 columns
...
### save output
#saveRDS(empty_list, "../outputs/WrightResid/Carterocephalus_palaemon_ModelA_detWright_allYrs_lineCols_list.rds")  ###  
###############################################
### Read and plot binned det residuals
#empty_list <- readRDS("../outputs/WrightResid/Carterocephalus_palaemon_ModelA_detWright_allYrs_lineCols_list.rds")  
